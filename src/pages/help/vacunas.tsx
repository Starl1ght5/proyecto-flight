...
export default function Devoluciones() {
  ...
  const preguntas = [
    {
      pregunta: "Si visité Brasil, Angola, Congo y/o Uganda, ¿qué requisitos debo cumplir para viajar a Colombia?",
      respuesta:
        "En caso de haber visitado o transitado por Brasil, Angola, Congo y/o Uganda, los pasajeros que viajen a Colombia deben presentar en el Check-in: Certificado Internacional de Fiebre Amarilla (con fecha de emision 10 días de antelación al viaje).",
    },
    {
      pregunta: "¿Qué vacunas necesito para viajar a otro país?",
      respuesta:
        "Dependerá de distintos factores, tales como tu país de origen, conexiones de tu vuelo y estadías recientes en zonas endémicas o consideradas de riesgo.",
    },
  ];
