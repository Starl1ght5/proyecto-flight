...
export default function NeedTravel() {
  const [openIndex, setOpenIndex] = useState<number | null>(null);

  const preguntas = [
    {
      pregunta: "¿Dónde puedo revisar las condiciones del destino al que quiero viajar?",
      respuesta:
        "Lleva tu tarjeta de embarque digital para tener actualizado en tiempo real tu viaje. Revisa siempre las condiciones específicas de tu destino antes de viajar.",
    },
    {
      pregunta: "Política de uso de mascarillas en los vuelos ROYAL",
      respuesta:
        "Siguiendo las recomendaciones de las autoridades locales, el uso de mascarillas es opcional a bordo de todos los vuelos ROYAL. Sin embargo, te recomendamos llevar una contigo.",
    },
  ];
