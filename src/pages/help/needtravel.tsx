  ...
  const preguntas = [
    {
        ...
        respuesta:
          "Lleva tu tarjeta de embarque digital para tener actualizado en tiempo real tu viaje.",
      },
      {
        pregunta: "Política de uso de mascarillas en los vuelos ROYAL",
        respuesta:
          "Siguiendo las recomendaciones de las autoridades locales, el uso de mascarillas es opcional a bordo de todos los vuelos ROYAL.",
      },
  ];
