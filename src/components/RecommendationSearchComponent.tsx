    ...
    <div className="px-20">
      ...
      />
        ...
        <div className="text-center mb-6">
            ...
            <div className="w-lg h-1 mb-3 bg-purple2 mx-auto rounded-full"></div>
        </div>
      ...
      {!searched ? (
        <div>
          <div className="flex flex-row justify-center">
            <form onSubmit={onSubmit}>
              <div className="flex flex-col gap-3 font-light bg-white rounded-lg shadow-2xl px-10 py-7 mb-4 boder-1 border-black">
                <h2 className="font-[500] text-2xl">
                  ¿Que buscas en tu viaje?
                </h2>

                <h2 className="text-lg font-extralight">
                  poner aca algo relacionado con lo de abajo en forma de
                  pregunta ¿?
                </h2>
        ...
        <div className="flex flex-row justify-center">
            <div className="w-5/6">
                <div className="rounded-lg shadow-2xl grid grid-cols-2">
                    <div className="rounded-l-lg shadow-lg px-6 py-4 bg-lilac">
                        {recommendedLocation?.map((element) => (
                            <LocationCard location={element} />
                        ))}
                    </div>

                    <div className="flex flex-col px-6 py-4 rounded-r-lg shadow-lg justify-between">
                        
                        <div>
                            <h2 className="text-xl font-extralight">Te recomendamos</h2>  
                            <h1 className="text-2xl mb-2 font-[500]" >{name}!</h1>
                            <p className="font-light">Porque es el destino que mas se asemeja a lo que estas buscando!</p>
                            <p className="font-light">poner aca una lista de cosas interesante o alguna bobada para rellenar</p>
                        </div>

                        <div className="flex flex-row gap-5 justify-center">
                            <p className="place-self-center font-light text-gray-600 italic">No te gusto?</p>
                            <button onClick={reset} className="bg-lilac rounded-lg hover:scale-105 duration-300 ease-in-out px-6 py-2 text-white hover:cursor-pointer" >Busca otro destino!</button> 
                        </div>
